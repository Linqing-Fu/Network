...
if __name__ == '__main__':
    ...
    h2.cmd('ifconfig h2-eth0 10.0.2.33/24')
    ...
    r1.cmd('route add -net 10.0.4.0 netmask 255.255.255.0 gw 10.0.3.2 dev r1-eth1')
    ...
    r2.cmd('route add -net 10.0.2.0 netmask 255.255.255.0 gw 10.0.4.3 dev r2-eth1')
    r3.cmd('route add -net 10.0.1.0 netmask 255.255.255.0 gw 10.0.4.1 dev r3-eth0')
    r3.cmd('route add -net 10.0.3.0 netmask 255.255.255.0 gw 10.0.4.1 dev r3-eth0')
    ...
    for r in (r1, r2, r3):
        ...
        r.cmd('./router &') # run router in the background
